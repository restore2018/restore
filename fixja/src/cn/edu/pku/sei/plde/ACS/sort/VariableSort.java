...
import cn.edu.pku.sei.plde.ACS.IdentifierCollectVisitor;
...
public class VariableSort {
    ...
    public VariableSort(Set<String> suspiciousVariableSet, String statements) {
        if (suspiciousVariableSet == null) suspiciousVariableSet = new HashSet<>();
    ...
    private void topologicalSort() {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (suspiciousVariableSet.contains(key.trim()) || suspiciousVariableSet.size() == 0) {
